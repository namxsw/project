                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> <a href="ad_stdInfo.php ?Applicant_ID= <?php echo $row['Applicant_ID'] ?>"><button type="button" class="btn btn-outline-warning">ไม่ผ่าน</button></a>
                                            <button type="button" class="btn btn-outline-success modal_data" id="<?php echo $row['Applicant_ID'] ?>">ผ่าน</button></td>
